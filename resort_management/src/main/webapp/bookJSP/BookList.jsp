            ...
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div  class="d-flex">
                            <div>
                                <a href="/BookServlet?action=create" class="btn btn-outline-success" role="button">Create</a>
                            </div>
                            <div>
                                <form action="/BookServlet" method="get" class="d-flex" role="search">
            ...
            <table class="table">
                ...
                <c:forEach items="${list}" var="list" varStatus="state">
                    <tr>
                        ...
                        <td>${list.date_in}</td>
                        <td>${list.date_out}</td>
                        <td><a href="/BookServlet?action=update&id=${list.id}">UP</a></td>
