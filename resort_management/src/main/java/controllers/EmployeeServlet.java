...
public class EmployeeServlet extends HttpServlet {
    IBaseServices<Employee> repositories = new EmployeeServices();
    ITypeRepositories<Gender> genderRepositories = new GenderRepositories();
    ITypeRepositories<Position> positionRepositories = new PositionRepositories();
    ITypeRepositories<Degree> degreeRepositories = new DegreeRepositories();
